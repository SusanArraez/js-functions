...
}; //make a little bit more clear that fn is stored in variable
...
// arrow implied return statement
...
console.log('call addTwonNums(2,2)', addTwoNums(2, 2));
console.log('concateateStrings("taco", "Cat")', concatenateStrings("taco", "cat"));
